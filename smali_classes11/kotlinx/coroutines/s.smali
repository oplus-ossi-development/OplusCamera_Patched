...
# static fields
.field public static final a:Lkotlinx/coroutines/s;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v0}, Lkotlinx/coroutines/s;-><init>()V

    sput-object v0, Lkotlinx/coroutines/s;->a:Lkotlinx/coroutines/s;
    ...
    .line 37
    :goto_1
    sput v0, Lkotlinx/coroutines/s;->e:I
...
.method private final a()I
    ...
    .line 47
    sget p0, Lkotlinx/coroutines/s;->e:I
    ...
    invoke-static {p0, v1}, Lkotlin/b/l;->c(II)I
...
.method private final b()Ljava/util/concurrent/ExecutorService;
    ...
    invoke-direct {p0}, Lkotlinx/coroutines/s;->c()Ljava/util/concurrent/ExecutorService;
    ...
    .line 64
    sget-boolean v2, Lkotlinx/coroutines/s;->f:Z

    const/4 v3, 0x0

    if-nez v2, :cond_4

    sget v2, Lkotlinx/coroutines/s;->e:I
    ...
    .line 66
    sget-object v4, Lkotlinx/coroutines/s;->a:Lkotlinx/coroutines/s;

    invoke-virtual {v4, v1, v2}, Lkotlinx/coroutines/s;->a(Ljava/lang/Class;Ljava/util/concurrent/ExecutorService;)Z
    ...
    invoke-direct {v4}, Lkotlinx/coroutines/s;->a()I
...
.method private final c()Ljava/util/concurrent/ExecutorService;
    ...
    .line 92
    invoke-direct {p0}, Lkotlinx/coroutines/s;->a()I

    move-result p0

    new-instance v1, Lkotlinx/coroutines/s$a;

    invoke-direct {v1, v0}, Lkotlinx/coroutines/s$a;-><init>(Ljava/util/concurrent/atomic/AtomicInteger;)V
...
.method private final declared-synchronized d()Ljava/util/concurrent/Executor;
    ...
    .line 99
    :try_start_0
    sget-object v0, Lkotlinx/coroutines/s;->pool:Ljava/util/concurrent/Executor;
    ...
    :cond_0
    invoke-direct {p0}, Lkotlinx/coroutines/s;->b()Ljava/util/concurrent/ExecutorService;
    ...
    sput-object v1, Lkotlinx/coroutines/s;->pool:Ljava/util/concurrent/Executor;
...
.method public a(Lkotlin/coroutines/f;Ljava/lang/Runnable;)V
    ...
    .line 103
    :try_start_0
    sget-object p1, Lkotlinx/coroutines/s;->pool:Ljava/util/concurrent/Executor;
    ...
    :cond_0
    invoke-direct {p0}, Lkotlinx/coroutines/s;->d()Ljava/util/concurrent/Executor;
    ...
    invoke-interface {p0, p2}, Lkotlinx/coroutines/cn;->a(Ljava/lang/Runnable;)Ljava/lang/Runnable;
    ...
    invoke-virtual {p0, p2}, Lkotlinx/coroutines/am;->a(Ljava/lang/Runnable;)V
...
.method public final a(Ljava/lang/Class;Ljava/util/concurrent/ExecutorService;)Z
    ...
    .line 84
    sget-object p0, Lkotlinx/coroutines/s$b;->a:Lkotlinx/coroutines/s$b;
