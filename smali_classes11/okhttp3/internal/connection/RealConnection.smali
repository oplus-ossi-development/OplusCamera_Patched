...
.method private final connectTls(Lokhttp3/internal/connection/ConnectionSpecSelector;)V
    ...
    invoke-virtual {v5, v4}, Lokhttp3/Handshake$Companion;->get(Ljavax/net/ssl/SSLSession;)Lokhttp3/Handshake;
    ...
    .line 394
    invoke-static {p0, v3, v8, v3}, Lkotlin/text/n;->a(Ljava/lang/String;Ljava/lang/String;ILjava/lang/Object;)Ljava/lang/String;
    ...
    .line 404
    invoke-virtual {v5}, Lokhttp3/Handshake;->localCertificates()Ljava/util/List;

    move-result-object v8

    new-instance v9, Lokhttp3/internal/connection/RealConnection$connectTls$1;

    invoke-direct {v9, v0, v5, v1}, Lokhttp3/internal/connection/RealConnection$connectTls$1;-><init>(Lokhttp3/CertificatePinner;Lokhttp3/Handshake;Lokhttp3/Address;)V

    check-cast v9, Lkotlin/jvm/a/a;

    .line 403
    invoke-direct {v4, v6, v7, v8, v9}, Lokhttp3/Handshake;-><init>(Lokhttp3/TlsVersion;Lokhttp3/CipherSuite;Ljava/util/List;Lkotlin/jvm/a/a;)V
    ...
    invoke-virtual {v0, v1, v4}, Lokhttp3/CertificatePinner;->check$okhttp(Ljava/lang/String;Lkotlin/jvm/a/a;)V
    ...
    invoke-virtual {p1, v3}, Lokhttp3/Protocol$Companion;->get(Ljava/lang/String;)Lokhttp3/Protocol;
...
.method private final createTunnel(IILokhttp3/Request;Lokhttp3/HttpUrl;)Lokhttp3/Request;
    ...
    invoke-static {v2, p3, v1}, Lkotlin/text/n;->a(Ljava/lang/String;Ljava/lang/String;Z)Z
