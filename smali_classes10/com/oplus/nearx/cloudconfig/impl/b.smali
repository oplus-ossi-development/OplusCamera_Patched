...
# virtual methods
.method public a(Lcom/oplus/nearx/cloudconfig/bean/d;Ljava/util/List;)Ljava/lang/Object;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<ResultT:",
    ...
    .line 66
    sget-object p0, Lcom/oplus/nearx/cloudconfig/impl/i;->b:Lcom/oplus/nearx/cloudconfig/impl/i$a;

    invoke-virtual {p0}, Lcom/oplus/nearx/cloudconfig/impl/i$a;->a()Lcom/oplus/nearx/cloudconfig/impl/i;

    move-result-object p0

    invoke-interface {p0, p1, p2}, Lcom/oplus/nearx/cloudconfig/impl/i;->a(Lcom/oplus/nearx/cloudconfig/bean/d;Ljava/util/List;)Ljava/lang/Object;
...
.method public a(Ljava/lang/String;Lcom/oplus/nearx/cloudconfig/bean/e;[Ljava/lang/Object;)Ljava/lang/Object;
    .locals 12
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 40
    new-instance v0, Lcom/oplus/nearx/cloudconfig/bean/d;
    ...
    .line 41
    :cond_0
    invoke-virtual {p2}, Lcom/oplus/nearx/cloudconfig/bean/e;->a()Ljava/lang/String;
    ...
    .line 40
    invoke-direct/range {v1 .. v9}, Lcom/oplus/nearx/cloudconfig/bean/d;-><init>(Ljava/lang/String;Ljava/util/Map;Ljava/util/Map;Ljava/lang/Object;Ljava/util/Map;Ljava/util/List;ILkotlin/jvm/internal/o;)V

    .line 50
    invoke-virtual {p2}, Lcom/oplus/nearx/cloudconfig/bean/e;->b()[Lcom/oplus/nearx/cloudconfig/proxy/a;
    ...
    :goto_2
    invoke-virtual {v4, v0, v3}, Lcom/oplus/nearx/cloudconfig/proxy/a;->a(Lcom/oplus/nearx/cloudconfig/bean/d;Ljava/lang/Object;)V
    ...
    .line 53
    :cond_3
    invoke-virtual {v0}, Lcom/oplus/nearx/cloudconfig/bean/d;->c()Ljava/lang/String;

    move-result-object p3

    const-string v1, "config_code"

    invoke-virtual {v0, v1, p3}, Lcom/oplus/nearx/cloudconfig/bean/d;->a(Ljava/lang/String;Ljava/lang/Object;)V
    ...
    .line 60
    check-cast p0, Lcom/oplus/nearx/cloudconfig/impl/i;

    invoke-virtual {p1, v0, p0}, Lcom/oplus/nearx/cloudconfig/impl/k;->a(Lcom/oplus/nearx/cloudconfig/bean/d;Lcom/oplus/nearx/cloudconfig/impl/i;)Ljava/lang/Object;
...
.method public a()Ljava/lang/reflect/Type;
    ...
    .line 24
    invoke-static {v2, v0}, Lcom/oplus/nearx/cloudconfig/d/e;->a(ILjava/lang/reflect/ParameterizedType;)Ljava/lang/reflect/Type;

    move-result-object v0

    .line 28
    iget-boolean p0, p0, Lcom/oplus/nearx/cloudconfig/impl/b;->f:Z
    ...
    :cond_1
    :goto_0
    invoke-static {v0}, Lcom/oplus/nearx/cloudconfig/d/e;->a(Ljava/lang/reflect/Type;)Ljava/lang/Class;
    ...
    .line 36
    :cond_3
    iget-object p0, p0, Lcom/oplus/nearx/cloudconfig/impl/b;->e:Ljava/lang/reflect/Type;
