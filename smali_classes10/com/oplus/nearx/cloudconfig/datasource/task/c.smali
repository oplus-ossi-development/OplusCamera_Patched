...
.method public constructor <init>(Lcom/oplus/nearx/cloudconfig/datasource/d;Ljava/io/InputStream;Ljava/lang/String;Lkotlin/jvm/a/b;)V
    ...
    .line 20
    iput-object v0, p0, Lcom/oplus/nearx/cloudconfig/datasource/task/c;->a:Ljava/lang/String;
...
.method private final a(Ljava/io/InputStream;)Lcom/oplus/nearx/cloudconfig/bean/b;
    ...
    .line 58
    :try_start_0
    invoke-static {p1}, Lcom/oplus/nearx/cloudconfig/bean/f;->a(Ljava/io/InputStream;)Lokio/Source;

    move-result-object v1

    invoke-static {v1}, Lcom/oplus/nearx/cloudconfig/bean/f;->b(Lokio/Source;)Lokio/BufferedSource;
    ...
    .line 74
    iget-object v4, p0, Lcom/oplus/nearx/cloudconfig/datasource/task/c;->c:Lcom/oplus/nearx/cloudconfig/datasource/d;

    invoke-virtual {v4, v1, v12}, Lcom/oplus/nearx/cloudconfig/datasource/d;->a(Ljava/lang/String;I)Z
    ...
    iget-object p0, p0, Lcom/oplus/nearx/cloudconfig/datasource/task/c;->a:Ljava/lang/String;

    invoke-interface {v2, p0}, Lkotlin/jvm/a/b;->invoke(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object p0

    check-cast p0, Lcom/oplus/nearx/cloudconfig/bean/b;

    .line 83
    invoke-virtual {p0, v13}, Lcom/oplus/nearx/cloudconfig/bean/b;->c(I)V

    .line 84
    invoke-virtual {p0, v1}, Lcom/oplus/nearx/cloudconfig/bean/b;->d(I)V

    .line 85
    invoke-virtual {p0, v4}, Lcom/oplus/nearx/cloudconfig/bean/b;->a(Ljava/lang/String;)V
    :try_end_1
    ...
    .line 99
    invoke-static {v2}, Lcom/oplus/nearx/cloudconfig/bean/f;->a(Ljava/io/File;)Lokio/Sink;
    ...
    .line 107
    invoke-virtual {v2, v12}, Lcom/oplus/nearx/cloudconfig/bean/b;->d(I)V

    .line 108
    invoke-virtual {v2, v1}, Lcom/oplus/nearx/cloudconfig/bean/b;->a(Ljava/lang/String;)V

    .line 109
    invoke-virtual {v2}, Lcom/oplus/nearx/cloudconfig/bean/b;->b()Lcom/oplus/nearx/cloudconfig/datasource/d;

    move-result-object v1

    invoke-virtual {v2}, Lcom/oplus/nearx/cloudconfig/bean/b;->c()Ljava/lang/String;

    move-result-object v2

    invoke-virtual {v1, v2, v12}, Lcom/oplus/nearx/cloudconfig/datasource/d;->b(Ljava/lang/String;I)V
...
.method private final d()Lcom/oplus/nearx/cloudconfig/datasource/task/LocalSourceCloudTask$logic$2$1;
    ...
    iget-object p0, p0, Lcom/oplus/nearx/cloudconfig/datasource/task/c;->b:Lkotlin/d;

    invoke-interface {p0}, Lkotlin/d;->getValue()Ljava/lang/Object;

    move-result-object p0

    check-cast p0, Lcom/oplus/nearx/cloudconfig/datasource/task/LocalSourceCloudTask$logic$2$1;
...
.method public final b()Lcom/oplus/nearx/cloudconfig/datasource/task/h;
    ...
    invoke-virtual {p0}, Lcom/oplus/nearx/cloudconfig/datasource/task/LocalSourceCloudTask$logic$2$1;->a()Ljava/lang/Object;

    move-result-object p0

    check-cast p0, Lcom/oplus/nearx/cloudconfig/datasource/task/h;
...
.method public c()Lcom/oplus/nearx/cloudconfig/datasource/task/h;
    ...
    .line 40
    new-instance p0, Lcom/oplus/nearx/cloudconfig/datasource/task/h;
    ...
    invoke-direct {p0, v0, v2, v1}, Lcom/oplus/nearx/cloudconfig/datasource/task/h;-><init>(ZLjava/lang/String;Lcom/oplus/nearx/cloudconfig/bean/a;)V
    ...
    .line 47
    invoke-virtual {p0}, Lcom/oplus/nearx/cloudconfig/bean/b;->h()Ljava/lang/String;
    ...
    invoke-virtual {p0}, Lcom/oplus/nearx/cloudconfig/bean/b;->c()Ljava/lang/String;

    move-result-object v4

    invoke-virtual {p0}, Lcom/oplus/nearx/cloudconfig/bean/b;->d()I

    move-result v5

    invoke-virtual {p0}, Lcom/oplus/nearx/cloudconfig/bean/b;->e()I

    move-result p0

    invoke-direct {v3, v4, v5, p0}, Lcom/oplus/nearx/cloudconfig/bean/a;-><init>(Ljava/lang/String;II)V

    .line 46
    invoke-direct {v0, v1, v2, v3}, Lcom/oplus/nearx/cloudconfig/datasource/task/h;-><init>(ZLjava/lang/String;Lcom/oplus/nearx/cloudconfig/bean/a;)V
