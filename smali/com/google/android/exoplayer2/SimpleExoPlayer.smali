...
# static fields
.field private static FAST_SEEK_TIME_OUT_INTERVAL_MS:I = 0x1388
...
.field private isEnablePreview:Z
...
.field private pendingFastSeekTime:J

.field private pendingPlayWhenReady:Z

.field private pendingPreviewFlag:Z
...
.field private seekTimeoutRunnable:Ljava/lang/Runnable;

.field private seekingTime:J
...
.method protected constructor <init>(Landroid/content/Context;Lcom/google/android/exoplayer2/RenderersFactory;Lcom/google/android/exoplayer2/trackselection/TrackSelector;Lcom/google/android/exoplayer2/LoadControl;Lcom/google/android/exoplayer2/drm/DrmSessionManager;Lcom/google/android/exoplayer2/upstream/BandwidthMeter;Lcom/google/android/exoplayer2/analytics/AnalyticsCollector$Factory;Lcom/google/android/exoplayer2/util/Clock;Landroid/os/Looper;)V
    ...
    .line 251
    invoke-virtual {v1, v0}, Lcom/google/android/exoplayer2/analytics/AnalyticsCollector;->addListener(Lcom/google/android/exoplayer2/analytics/AnalyticsListener;)V
    ...
    invoke-direct {v1, v2, v3}, Lcom/google/android/exoplayer2/audio/AudioFocusManager;-><init>(Landroid/content/Context;Lcom/google/android/exoplayer2/audio/AudioFocusManager$PlayerControl;)V
    ...
    .line 257
    iput-boolean v1, v0, Lcom/google/android/exoplayer2/SimpleExoPlayer;->isSeeking:Z

    const-wide v2, -0x7fffffffffffffffL    # -4.9E-324

    .line 258
    iput-wide v2, v0, Lcom/google/android/exoplayer2/SimpleExoPlayer;->seekingTime:J

    const/4 v4, -0x1

    .line 259
    iput v4, v0, Lcom/google/android/exoplayer2/SimpleExoPlayer;->curSeekId:I

    .line 260
    iput-wide v2, v0, Lcom/google/android/exoplayer2/SimpleExoPlayer;->pendingFastSeekTime:J

    .line 261
    iput-boolean v1, v0, Lcom/google/android/exoplayer2/SimpleExoPlayer;->pendingPreviewFlag:Z

    .line 262
    iput-boolean v1, v0, Lcom/google/android/exoplayer2/SimpleExoPlayer;->isEnablePreview:Z

    .line 263
    new-instance v1, Lcom/google/android/exoplayer2/SimpleExoPlayer$$ExternalSyntheticLambda0;

    invoke-direct {v1, v0}, Lcom/google/android/exoplayer2/SimpleExoPlayer$$ExternalSyntheticLambda0;-><init>(Lcom/google/android/exoplayer2/SimpleExoPlayer;)V

    iput-object v1, v0, Lcom/google/android/exoplayer2/SimpleExoPlayer;->seekTimeoutRunnable:Ljava/lang/Runnable;
...
.method private seekToInternal(IJI)V
    .locals 2

    const/4 v0, 0x1

    .line 1029
    iput-boolean v0, p0, Lcom/google/android/exoplayer2/SimpleExoPlayer;->isSeeking:Z

    .line 1030
    iput-wide p2, p0, Lcom/google/android/exoplayer2/SimpleExoPlayer;->seekingTime:J

    .line 1031
    iget v1, p0, Lcom/google/android/exoplayer2/SimpleExoPlayer;->curSeekId:I

    add-int/2addr v1, v0

    iput v1, p0, Lcom/google/android/exoplayer2/SimpleExoPlayer;->curSeekId:I
    ...
    .line 1032
    iput v0, p0, Lcom/google/android/exoplayer2/SimpleExoPlayer;->curSeekId:I
    ...
    const-string v1, "SeekToInternal curSeekId:"
    ...
    invoke-virtual {v0, v1, p4}, Lcom/google/android/exoplayer2/ExoPlayerImpl;->setSeekIdAndType(II)V

    .line 1037
    invoke-direct {p0}, Lcom/google/android/exoplayer2/SimpleExoPlayer;->verifyApplicationThread()V

    .line 1038
    iget-object p4, p0, Lcom/google/android/exoplayer2/SimpleExoPlayer;->analyticsCollector:Lcom/google/android/exoplayer2/analytics/AnalyticsCollector;

    invoke-virtual {p4}, Lcom/google/android/exoplayer2/analytics/AnalyticsCollector;->notifySeekStarted()V
...
.method private updatePlayWhenReady(ZI)V
    ...
    .line 1303
    iget-boolean v0, p0, Lcom/google/android/exoplayer2/SimpleExoPlayer;->isEnablePreview:Z

    if-eqz v0, :cond_0

    .line 1304
    iput-boolean p1, p0, Lcom/google/android/exoplayer2/SimpleExoPlayer;->pendingPlayWhenReady:Z
...
.method public varargs blockingSendMessages([Lcom/google/android/exoplayer2/ExoPlayer$ExoPlayerMessage;)V
    ...
    invoke-virtual {p0, p1}, Lcom/google/android/exoplayer2/ExoPlayerImpl;->blockingSendMessages([Lcom/google/android/exoplayer2/ExoPlayer$ExoPlayerMessage;)V
...
.method public fastSeekTo(IJZ)V
    ...
    const-string p1, "fastSeekTo with invalid positionMs:"
    ...
    invoke-static {v1, p0}, Lcom/google/android/exoplayer2/util/Log;->e(Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string v2, ",isSeeking:"

    invoke-virtual {v0, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v0

    iget-boolean v2, p0, Lcom/google/android/exoplayer2/SimpleExoPlayer;->isSeeking:Z

    invoke-virtual {v0, v2}, Ljava/lang/StringBuilder;->append(Z)Ljava/lang/StringBuilder;

    move-result-object v0

    const-string v2, ",isEnablePreview:"

    invoke-virtual {v0, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v0

    iget-boolean v2, p0, Lcom/google/android/exoplayer2/SimpleExoPlayer;->isEnablePreview:Z
    ...
    iput-boolean v2, p0, Lcom/google/android/exoplayer2/SimpleExoPlayer;->pendingPlayWhenReady:Z

    .line 527
    invoke-virtual {p0, v1}, Lcom/google/android/exoplayer2/SimpleExoPlayer;->setPlayWhenReady(Z)V

    .line 528
    iput-boolean v0, p0, Lcom/google/android/exoplayer2/SimpleExoPlayer;->isEnablePreview:Z
    ...
    .line 532
    iput-boolean v1, p0, Lcom/google/android/exoplayer2/SimpleExoPlayer;->isEnablePreview:Z

    .line 533
    iget-boolean v1, p0, Lcom/google/android/exoplayer2/SimpleExoPlayer;->pendingPlayWhenReady:Z
    ...
    .line 537
    :goto_1
    invoke-direct {p0, p1, p2, p3, v0}, Lcom/google/android/exoplayer2/SimpleExoPlayer;->seekToInternal(IJI)V
...
.method public getAudioStreamType()I
    ...
    invoke-static {p0}, Lcom/google/android/exoplayer2/util/Util;->getStreamTypeForAudioUsage(I)I
...
.method public getCurrentManifest()Ljava/lang/Object;
    ...
    invoke-virtual {p0}, Lcom/google/android/exoplayer2/ExoPlayerImpl;->getCurrentManifest()Ljava/lang/Object;
...
.method public getCurrentPosition()J
    ...
    .line 1188
    iget-boolean v0, p0, Lcom/google/android/exoplayer2/SimpleExoPlayer;->isSeeking:Z
    ...
    const-string v1, "return seekingTime:"

    invoke-virtual {v0, v1}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v0

    iget-wide v1, p0, Lcom/google/android/exoplayer2/SimpleExoPlayer;->seekingTime:J
    ...
    .line 1190
    iget-wide v0, p0, Lcom/google/android/exoplayer2/SimpleExoPlayer;->seekingTime:J
...
.method public getPlaybackError()Lcom/google/android/exoplayer2/ExoPlaybackException;
    ...
    invoke-virtual {p0}, Lcom/google/android/exoplayer2/ExoPlayerImpl;->getPlaybackError()Lcom/google/android/exoplayer2/ExoPlaybackException;
...
.method public synthetic lambda$new$0$SimpleExoPlayer()V
    .locals 2

    .line 264
    iget v0, p0, Lcom/google/android/exoplayer2/SimpleExoPlayer;->curSeekId:I

    const/4 v1, 0x1

    invoke-virtual {p0, v0, v1}, Lcom/google/android/exoplayer2/SimpleExoPlayer;->onSeekCompleted(II)V
...
.method public onSeekCompleted(II)V
    ...
    const-string v1, "onSeekCompleted, id:"
    ...
    .line 509
    iget-boolean p2, p0, Lcom/google/android/exoplayer2/SimpleExoPlayer;->isSeeking:Z

    if-eqz p2, :cond_1

    iget p2, p0, Lcom/google/android/exoplayer2/SimpleExoPlayer;->curSeekId:I
    ...
    .line 512
    iput-boolean p1, p0, Lcom/google/android/exoplayer2/SimpleExoPlayer;->isSeeking:Z
...
.method public seekTo(IJ)V
    ...
    const-string p1, "seekTo with invalid positionMs:"
...
.method public varargs sendMessages([Lcom/google/android/exoplayer2/ExoPlayer$ExoPlayerMessage;)V
    ...
    invoke-virtual {p0, p1}, Lcom/google/android/exoplayer2/ExoPlayerImpl;->sendMessages([Lcom/google/android/exoplayer2/ExoPlayer$ExoPlayerMessage;)V
...
.method public setDropFramePolicy(I)V
    .locals 6
