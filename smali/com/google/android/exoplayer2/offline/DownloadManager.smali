...
# direct methods
.method public static synthetic $r8$lambda$5dlYJWJOacdg_qINlgAxFemp37I(Landroid/os/ConditionVariable;)V
    .locals 0
...
.method private addTaskForAction(Lcom/google/android/exoplayer2/offline/DownloadAction;)Lcom/google/android/exoplayer2/offline/DownloadManager$Task;
    ...
    const-string p0, "Task is added"

    .line 349
    invoke-static {p0, v6}, Lcom/google/android/exoplayer2/offline/DownloadManager;->logd(Ljava/lang/String;Lcom/google/android/exoplayer2/offline/DownloadManager$Task;)V
...
.method private loadActions()V
    ...
    invoke-direct {v1, p0}, Lcom/google/android/exoplayer2/offline/DownloadManager$$ExternalSyntheticLambda1;-><init>(Lcom/google/android/exoplayer2/offline/DownloadManager;)V
...
.method private saveActions()V
    ...
    new-instance v2, Lcom/google/android/exoplayer2/offline/DownloadManager$$ExternalSyntheticLambda3;

    invoke-direct {v2, p0, v0}, Lcom/google/android/exoplayer2/offline/DownloadManager$$ExternalSyntheticLambda3;-><init>(Lcom/google/android/exoplayer2/offline/DownloadManager;[Lcom/google/android/exoplayer2/offline/DownloadAction;)V
...
.method public synthetic lambda$saveActions$2$DownloadManager([Lcom/google/android/exoplayer2/offline/DownloadAction;)V
    ...
    invoke-virtual {p0, p1}, Lcom/google/android/exoplayer2/offline/ActionFile;->store([Lcom/google/android/exoplayer2/offline/DownloadAction;)V

    const-string p0, "Actions persisted."
    ...
    const-string v0, "Persisting actions failed."
...
.method public release()V
    ...
    new-instance v2, Lcom/google/android/exoplayer2/offline/DownloadManager$$ExternalSyntheticLambda0;

    invoke-direct {v2, v0}, Lcom/google/android/exoplayer2/offline/DownloadManager$$ExternalSyntheticLambda0;-><init>(Landroid/os/ConditionVariable;)V
    ...
    .line 342
    iget-object p0, p0, Lcom/google/android/exoplayer2/offline/DownloadManager;->fileIOThread:Landroid/os/HandlerThread;
...
.method public startDownloads()V
    ...
    const-string p0, "Downloads are started"
...
.method public stopDownloads()V
    ...
    :cond_0
    const-string p0, "Downloads are stopping"
