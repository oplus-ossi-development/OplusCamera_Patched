...
.method private a()Landroid/graphics/Path;
    ...
    .line 96
    iget-object p0, p0, Lcom/coui/appcompat/poplist/RoundFrameLayout;->a:Landroid/graphics/Path;
...
.method private a(Landroid/graphics/Canvas;)V
    ...
    .line 80
    iget-object v0, p0, Lcom/coui/appcompat/poplist/RoundFrameLayout;->c:Landroid/graphics/RectF;
    ...
    .line 82
    invoke-direct {p0}, Lcom/coui/appcompat/poplist/RoundFrameLayout;->a()Landroid/graphics/Path;
...
.method protected dispatchDraw(Landroid/graphics/Canvas;)V
    ...
    .line 73
    invoke-direct {p0, p1}, Lcom/coui/appcompat/poplist/RoundFrameLayout;->b(Landroid/graphics/Canvas;)V

    goto :goto_0

    .line 75
    :cond_0
    invoke-direct {p0, p1}, Lcom/coui/appcompat/poplist/RoundFrameLayout;->a(Landroid/graphics/Canvas;)V
...
.method protected onSizeChanged(IIII)V
    ...
    invoke-virtual {p0}, Lcom/coui/appcompat/poplist/RoundFrameLayout;->getPaddingLeft()I

    move-result p4

    int-to-float p4, p4

    invoke-virtual {p0}, Lcom/coui/appcompat/poplist/RoundFrameLayout;->getPaddingTop()I

    move-result v0

    int-to-float v0, v0

    invoke-virtual {p0}, Lcom/coui/appcompat/poplist/RoundFrameLayout;->getPaddingRight()I
    ...
    invoke-virtual {p0}, Lcom/coui/appcompat/poplist/RoundFrameLayout;->getPaddingBottom()I
...
.method public setRadius(F)V
    ...
    .line 61
    invoke-virtual {p0}, Lcom/coui/appcompat/poplist/RoundFrameLayout;->postInvalidate()V
