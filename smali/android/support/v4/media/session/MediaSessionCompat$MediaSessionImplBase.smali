...
.field private mRemoteUserInfo:Landroidx/media/b$a;
...
.field private mVolumeCallback:Landroidx/media/f$a;

.field mVolumeProvider:Landroidx/media/f;
...
.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;Landroid/content/ComponentName;Landroid/app/PendingIntent;)V
    ...
    iput-object v1, p0, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->mVolumeCallback:Landroidx/media/f$a;
...
.method adjustVolume(II)V
    ...
    .line 2502
    iget-object p0, p0, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->mVolumeProvider:Landroidx/media/f;

    if-eqz p0, :cond_1

    .line 2503
    invoke-virtual {p0, p1}, Landroidx/media/f;->b(I)V
...
.method public getCurrentControllerInfo()Landroidx/media/b$a;
    .locals 1
    ...
    .line 2433
    :try_start_0
    iget-object p0, p0, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->mRemoteUserInfo:Landroidx/media/b$a;
...
.method public setCurrentControllerInfo(Landroidx/media/b$a;)V
    .locals 1
    ...
    .line 2440
    :try_start_0
    iput-object p1, p0, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->mRemoteUserInfo:Landroidx/media/b$a;
...
.method public setPlaybackToLocal(I)V
    ...
    .line 2103
    iget-object v0, p0, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->mVolumeProvider:Landroidx/media/f;
    ...
    .line 2104
    invoke-virtual {v0, v1}, Landroidx/media/f;->a(Landroidx/media/f$a;)V
...
.method public setPlaybackToRemote(Landroidx/media/f;)V
    .locals 7
    ...
    .line 2124
    iput-object p1, p0, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->mVolumeProvider:Landroidx/media/f;
    ...
    iget-object v1, p0, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->mVolumeProvider:Landroidx/media/f;

    .line 2126
    invoke-virtual {v1}, Landroidx/media/f;->b()I

    move-result v4

    iget-object v1, p0, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->mVolumeProvider:Landroidx/media/f;

    invoke-virtual {v1}, Landroidx/media/f;->c()I
    ...
    .line 2127
    invoke-virtual {v1}, Landroidx/media/f;->a()I
    ...
    .line 2130
    iget-object p0, p0, Landroid/support/v4/media/session/MediaSessionCompat$MediaSessionImplBase;->mVolumeCallback:Landroidx/media/f$a;

    invoke-virtual {p1, p0}, Landroidx/media/f;->a(Landroidx/media/f$a;)V
...
.method setVolumeTo(II)V
    ...
    .line 2513
    invoke-virtual {p0, p1}, Landroidx/media/f;->a(I)V
