...
.method public static a(Landroid/graphics/Canvas;Landroid/graphics/Paint;Ljava/lang/String;FFFFLjava/lang/String;)F
    ...
    :cond_1
    invoke-static {p2, p1}, La/a/b/f/p;->a(Ljava/lang/String;Landroid/graphics/Paint;)F
...
.method public static a(Landroid/content/Context;Landroid/content/res/AssetManager;Lco/polarr/renderer/entities/TextItem;Lco/polarr/renderer/entities/Context;La/a/b/c/d;)La/a/b/c/d;
    .locals 5
    ...
    invoke-static {p0, p1, p2, p3}, La/a/b/f/p;->a(Landroid/content/Context;Landroid/content/res/AssetManager;Lco/polarr/renderer/entities/TextItem;Lco/polarr/renderer/entities/Context;)Landroid/graphics/Bitmap;
    ...
    invoke-static {v3, p1, p2, p3}, La/a/b/f/f;->b(IIII)La/a/b/c/d;
    ...
    iput p1, p4, La/a/b/c/d;->b:I

    invoke-virtual {p0}, Landroid/graphics/Bitmap;->getHeight()I

    move-result p1

    iput p1, p4, La/a/b/c/d;->c:I
...
.method public static a(Landroid/content/Context;Landroid/content/res/AssetManager;Lco/polarr/renderer/entities/TextItem;La/a/b/f/p$b;)La/a/b/f/p$a;
    .locals 9

    iget-object v0, p3, La/a/b/f/p$b;->b:Landroid/graphics/RectF;

    iget v1, p3, La/a/b/f/p$b;->f:F

    iget v2, p3, La/a/b/f/p$b;->d:F

    iget v3, p3, La/a/b/f/p$b;->a:F
    ...
    iget v5, p3, La/a/b/f/p$b;->j:I

    invoke-static {p0, p1, p2, v5}, La/a/b/f/d;->a(Landroid/content/Context;Landroid/content/res/AssetManager;Lco/polarr/renderer/entities/TextItem;I)Landroid/graphics/Typeface;

    move-result-object v5

    invoke-virtual {v4, v5}, Landroid/text/TextPaint;->setTypeface(Landroid/graphics/Typeface;)Landroid/graphics/Typeface;

    iget v5, p3, La/a/b/f/p$b;->c:F
    ...
    invoke-static {p0, p1, p2, p3}, La/a/b/f/p;->a(Landroid/content/Context;Landroid/content/res/AssetManager;Ljava/lang/String;La/a/b/f/p$b;)[Ljava/lang/String;
    ...
    invoke-static {v7, v4}, La/a/b/f/p;->a(Ljava/lang/String;Landroid/graphics/Paint;)F
    ...
    :cond_1
    new-instance p3, La/a/b/f/p$a;

    invoke-direct {p3}, La/a/b/f/p$a;-><init>()V

    iput v6, p3, La/a/b/f/p$a;->a:F

    mul-float/2addr v2, p2

    add-float/2addr v2, v0

    iput v2, p3, La/a/b/f/p$a;->b:F

    iput-object p0, p3, La/a/b/f/p$a;->c:[Ljava/lang/String;
    ...
    iput-object p0, p3, La/a/b/f/p$a;->d:[Ljava/lang/Float;

    return-object p3
.end method

.method public static a(Landroid/content/Context;Landroid/content/res/AssetManager;Lco/polarr/renderer/entities/TextItem;I)La/a/b/f/p$b;
    .locals 7
    ...
    :goto_0
    iget-object v2, p2, Lco/polarr/renderer/entities/TextItem;->fontStyle:Ljava/lang/String;
    ...
    :cond_3
    :goto_1
    iget-object v2, p2, Lco/polarr/renderer/entities/TextItem;->fontWeight:Ljava/lang/String;
    ...
    invoke-static {p0, p1, p2, v3}, La/a/b/f/d;->a(Landroid/content/Context;Landroid/content/res/AssetManager;Lco/polarr/renderer/entities/TextItem;I)Landroid/graphics/Typeface;
    ...
    new-instance p0, La/a/b/f/p$b;

    invoke-direct {p0}, La/a/b/f/p$b;-><init>()V

    iput v1, p0, La/a/b/f/p$b;->a:F

    iput-object p3, p0, La/a/b/f/p$b;->b:Landroid/graphics/RectF;

    iput v0, p0, La/a/b/f/p$b;->c:F

    iget p1, p2, Lco/polarr/renderer/entities/TextItem;->lineHeight:F

    mul-float/2addr p1, v0

    iput p1, p0, La/a/b/f/p$b;->d:F

    const p1, 0x3c23d70a    # 0.01f

    mul-float/2addr p1, v0

    iput p1, p0, La/a/b/f/p$b;->e:F

    iget p1, p2, Lco/polarr/renderer/entities/TextItem;->letterSpacing:F

    mul-float/2addr v0, p1

    iput v0, p0, La/a/b/f/p$b;->f:F
    ...
    :goto_3
    iput-object p1, p0, La/a/b/f/p$b;->g:[F
    ...
    :goto_4
    iput-object p1, p0, La/a/b/f/p$b;->h:[F

    invoke-static {p2}, La/a/b/f/b;->a(Ljava/lang/Object;)Ljava/lang/String;

    move-result-object p1

    const-class p2, Lco/polarr/renderer/entities/TextItem;

    invoke-static {p1, p2}, La/a/b/f/b;->a(Ljava/lang/String;Ljava/lang/Class;)Ljava/lang/Object;

    move-result-object p1

    check-cast p1, Lco/polarr/renderer/entities/TextItem;

    iput-object p1, p0, La/a/b/f/p$b;->i:Lco/polarr/renderer/entities/TextItem;

    iput v3, p0, La/a/b/f/p$b;->j:I
...
.method public static a(Landroid/content/Context;Landroid/content/res/AssetManager;Lco/polarr/renderer/entities/TextItem;Lco/polarr/renderer/entities/Context;)Landroid/graphics/Bitmap;
    ...
    invoke-static {v0, v1, v2, v3}, La/a/b/f/p;->a(Landroid/content/Context;Landroid/content/res/AssetManager;Lco/polarr/renderer/entities/TextItem;I)La/a/b/f/p$b;

    move-result-object v3

    iget-object v4, v3, La/a/b/f/p$b;->b:Landroid/graphics/RectF;

    iget v13, v3, La/a/b/f/p$b;->f:F

    iget v14, v3, La/a/b/f/p$b;->d:F

    iget-object v5, v3, La/a/b/f/p$b;->g:[F
    ...
    iget v6, v3, La/a/b/f/p$b;->j:I

    invoke-static {v0, v1, v2, v6}, La/a/b/f/d;->a(Landroid/content/Context;Landroid/content/res/AssetManager;Lco/polarr/renderer/entities/TextItem;I)Landroid/graphics/Typeface;

    move-result-object v6

    invoke-virtual {v15, v6}, Landroid/text/TextPaint;->setTypeface(Landroid/graphics/Typeface;)Landroid/graphics/Typeface;

    iget v6, v3, La/a/b/f/p$b;->c:F

    invoke-virtual {v15, v6}, Landroid/text/TextPaint;->setTextSize(F)V

    invoke-static {v0, v1, v2, v3}, La/a/b/f/p;->a(Landroid/content/Context;Landroid/content/res/AssetManager;Lco/polarr/renderer/entities/TextItem;La/a/b/f/p$b;)La/a/b/f/p$a;

    move-result-object v0

    iget-object v1, v0, La/a/b/f/p$a;->c:[Ljava/lang/String;

    iget-object v11, v0, La/a/b/f/p$a;->d:[Ljava/lang/Float;

    iget v10, v0, La/a/b/f/p$a;->a:F

    iget v0, v0, La/a/b/f/p$a;->b:F
    ...
    iget-object v4, v3, La/a/b/f/p$b;->h:[F
    ...
    invoke-static {v4, v15}, La/a/b/f/p;->a([Ljava/lang/String;Landroid/text/TextPaint;)[F
    ...
    invoke-static/range {v5 .. v12}, La/a/b/f/p;->a(Landroid/graphics/Canvas;Landroid/graphics/Paint;Ljava/lang/String;FFFFLjava/lang/String;)F

    move-result v5

    add-int/lit8 v10, v26, 0x1

    add-float v6, v20, v13
...
.method public static a(Lco/polarr/renderer/entities/TextItem;Lco/polarr/renderer/entities/Context;La/a/b/c/d;)[F
    .locals 21
    ...
    iget-object v4, v1, Lco/polarr/renderer/entities/Context;->imageTexture:La/a/b/c/d;
    ...
    iget-object v0, v1, Lco/polarr/renderer/entities/Context;->imageTexture:La/a/b/c/d;
...
.method public static a([Ljava/lang/String;Landroid/text/TextPaint;)[F
    ...
    invoke-static {v4, p1}, La/a/b/f/p;->a(Ljava/lang/String;Landroid/graphics/Paint;)F
...
.method public static a(Landroid/content/Context;Landroid/content/res/AssetManager;Ljava/lang/String;La/a/b/f/p$b;)[Ljava/lang/String;
    .locals 18
    ...
    iget-object v3, v1, La/a/b/f/p$b;->i:Lco/polarr/renderer/entities/TextItem;

    iget v4, v1, La/a/b/f/p$b;->j:I

    move-object/from16 v5, p0

    move-object/from16 v6, p1

    invoke-static {v5, v6, v3, v4}, La/a/b/f/d;->a(Landroid/content/Context;Landroid/content/res/AssetManager;Lco/polarr/renderer/entities/TextItem;I)Landroid/graphics/Typeface;

    move-result-object v3

    invoke-virtual {v2, v3}, Landroid/text/TextPaint;->setTypeface(Landroid/graphics/Typeface;)Landroid/graphics/Typeface;

    iget v3, v1, La/a/b/f/p$b;->c:F

    invoke-virtual {v2, v3}, Landroid/text/TextPaint;->setTextSize(F)V

    iget v3, v1, La/a/b/f/p$b;->f:F

    iget v1, v1, La/a/b/f/p$b;->a:F
    ...
    invoke-static {v7, v2}, La/a/b/f/p;->a(Ljava/lang/String;Landroid/graphics/Paint;)F
    ...
    invoke-static {v4, v2}, La/a/b/f/p;->a(Ljava/lang/String;Landroid/graphics/Paint;)F
    ...
    invoke-static {v12, v7}, La/a/b/f/p;->a(Ljava/util/List;Ljava/lang/String;)Ljava/lang/String;
