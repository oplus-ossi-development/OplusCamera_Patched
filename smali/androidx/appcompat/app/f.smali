...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroidx/appcompat/app/f;->sConstructorSignature:[Ljava/lang/Class;
    ...
    .line 77
    sput-object v0, Landroidx/appcompat/app/f;->sOnClickAttrs:[I
    ...
    sput-object v0, Landroidx/appcompat/app/f;->sClassPrefixList:[Ljava/lang/String;
    ...
    sput-object v0, Landroidx/appcompat/app/f;->sConstructorMap:Landroidx/collection/SimpleArrayMap;
...
.method public constructor <init>()V
    ...
    .line 90
    iput-object v0, p0, Landroidx/appcompat/app/f;->mConstructorArgs:[Ljava/lang/Object;
...
.method private checkOnClickListener(Landroid/view/View;Landroid/util/AttributeSet;)V
    ...
    .line 316
    invoke-static {p1}, Landroidx/core/view/z;->I(Landroid/view/View;)Z
    ...
    .line 323
    :cond_0
    sget-object v0, Landroidx/appcompat/app/f;->sOnClickAttrs:[I
...
.method private createViewByPrefix(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Landroid/view/View;
    ...
    .line 333
    sget-object v0, Landroidx/appcompat/app/f;->sConstructorMap:Landroidx/collection/SimpleArrayMap;
    ...
    .line 343
    sget-object p3, Landroidx/appcompat/app/f;->sConstructorSignature:[Ljava/lang/Class;
    ...
    .line 347
    iget-object p0, p0, Landroidx/appcompat/app/f;->mConstructorArgs:[Ljava/lang/Object;
...
.method private createViewFromTag(Landroid/content/Context;Ljava/lang/String;Landroid/util/AttributeSet;)Landroid/view/View;
    ...
    .line 282
    :try_start_0
    iget-object v3, p0, Landroidx/appcompat/app/f;->mConstructorArgs:[Ljava/lang/Object;
    ...
    .line 286
    :goto_0
    sget-object v3, Landroidx/appcompat/app/f;->sClassPrefixList:[Ljava/lang/String;
    ...
    invoke-direct {p0, p1, p2, v3}, Landroidx/appcompat/app/f;->createViewByPrefix(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Landroid/view/View;
    ...
    :cond_3
    :try_start_1
    invoke-direct {p0, p1, p2, v1}, Landroidx/appcompat/app/f;->createViewByPrefix(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)Landroid/view/View;
...
.method final createView(Landroid/view/View;Ljava/lang/String;Landroid/content/Context;Landroid/util/AttributeSet;ZZZZ)Landroid/view/View;
    ...
    .line 104
    :cond_1
    invoke-static {p1, p4, p6, p7}, Landroidx/appcompat/app/f;->themifyContext(Landroid/content/Context;Landroid/util/AttributeSet;ZZ)Landroid/content/Context;
    ...
    .line 175
    invoke-virtual {p0, p1, p2, p4}, Landroidx/appcompat/app/f;->createView(Landroid/content/Context;Ljava/lang/String;Landroid/util/AttributeSet;)Landroid/view/View;
    ...
    .line 123
    :pswitch_0
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/f;->createButton(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatButton;

    move-result-object p5

    .line 124
    invoke-direct {p0, p5, p2}, Landroidx/appcompat/app/f;->verifyNotNull(Landroid/view/View;Ljava/lang/String;)V

    goto/16 :goto_2

    .line 127
    :pswitch_1
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/f;->createEditText(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatEditText;
    ...
    .line 139
    :pswitch_2
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/f;->createCheckBox(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatCheckBox;
    ...
    .line 151
    :pswitch_3
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/f;->createAutoCompleteTextView(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatAutoCompleteTextView;
    ...
    .line 119
    :pswitch_4
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/f;->createImageView(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatImageView;
    ...
    .line 167
    :pswitch_5
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/f;->createToggleButton(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatToggleButton;
    ...
    .line 143
    :pswitch_6
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/f;->createRadioButton(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatRadioButton;
    ...
    .line 131
    :pswitch_7
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/f;->createSpinner(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatSpinner;
    ...
    .line 163
    :pswitch_8
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/f;->createSeekBar(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatSeekBar;
    ...
    .line 135
    :pswitch_9
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/f;->createImageButton(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatImageButton;
    ...
    .line 115
    :pswitch_a
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/f;->createTextView(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatTextView;
    ...
    .line 155
    :pswitch_b
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/f;->createMultiAutoCompleteTextView(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatMultiAutoCompleteTextView;
    ...
    .line 147
    :pswitch_c
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/f;->createCheckedTextView(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatCheckedTextView;
    ...
    .line 159
    :pswitch_d
    invoke-virtual {p0, p1, p4}, Landroidx/appcompat/app/f;->createRatingBar(Landroid/content/Context;Landroid/util/AttributeSet;)Landroidx/appcompat/widget/AppCompatRatingBar;
    ...
    .line 181
    invoke-direct {p0, p1, p2, p4}, Landroidx/appcompat/app/f;->createViewFromTag(Landroid/content/Context;Ljava/lang/String;Landroid/util/AttributeSet;)Landroid/view/View;
    ...
    .line 186
    invoke-direct {p0, p5, p4}, Landroidx/appcompat/app/f;->checkOnClickListener(Landroid/view/View;Landroid/util/AttributeSet;)V
