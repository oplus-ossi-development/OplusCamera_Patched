...
.method static synthetic access$1000(Lcom/heytap/msp/sdk/common/dialog/DialogHelper;)V
    .locals 0
...
.method static synthetic access$1100(Lcom/heytap/msp/sdk/common/dialog/DialogHelper;)V
    .locals 0
...
.method static synthetic access$1200(Lcom/heytap/msp/sdk/common/dialog/DialogHelper;Ljava/lang/String;Ljava/lang/String;)V
    .locals 0
...
.method static synthetic access$1400(Lcom/heytap/msp/sdk/common/dialog/DialogHelper;)V
    .locals 0
...
.method static synthetic access$1500(Lcom/heytap/msp/sdk/common/dialog/DialogHelper;)Ljava/lang/String;
    .locals 0
...
.method static synthetic access$300(Lcom/heytap/msp/sdk/common/dialog/DialogHelper;ILjava/lang/String;)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lcom/heytap/msp/sdk/common/dialog/DialogHelper;->finish(ILjava/lang/String;)V

    return-void
.end method

.method static synthetic access$400(Lcom/heytap/msp/sdk/common/dialog/DialogHelper;)V
    .locals 0
...
.method static synthetic access$500(Lcom/heytap/msp/sdk/common/dialog/DialogHelper;)Lcom/heytap/msp/sdk/common/view/RingTypeProgressBar;
    .locals 0
...
.method static synthetic access$600(Lcom/heytap/msp/sdk/common/dialog/DialogHelper;)Landroid/widget/TextView;
    .locals 0
...
.method static synthetic access$700(Lcom/heytap/msp/sdk/common/dialog/DialogHelper;)V
    .locals 0
...
.method static synthetic access$800(Lcom/heytap/msp/sdk/common/dialog/DialogHelper;)Landroid/content/Context;
    .locals 0
...
.method static synthetic access$900(Lcom/heytap/msp/sdk/common/dialog/DialogHelper;)Landroid/os/Handler;
    .locals 0
...
.method private checkApkDownPath()V
    ...
    invoke-virtual {v1}, Lcom/heytap/msp/sdk/base/b;->g()I
...
.method private createTipsDialog()V
    ...
    const-string v1, "no foreground3"

    invoke-direct {p0, v0, v1}, Lcom/heytap/msp/sdk/common/dialog/DialogHelper;->finish(ILjava/lang/String;)V
...
.method private createVerifyFailDialog()V
    ...
    iget-object p0, p0, Lcom/heytap/msp/sdk/common/dialog/DialogHelper;->verifyFailDialog:Lcom/heytap/msp/sdk/common/dialog/CommonDialog;
...
.method private dismissInstallTipDialog()V
    ...
    iget-object p0, p0, Lcom/heytap/msp/sdk/common/dialog/DialogHelper;->installTipDialog:Lcom/heytap/msp/sdk/common/dialog/CommonDialog;
...
.method private dismissLoadFailDialog()V
    ...
    iget-object p0, p0, Lcom/heytap/msp/sdk/common/dialog/DialogHelper;->loadFailDialog:Lcom/heytap/msp/sdk/common/dialog/CommonDialog;
...
.method private dismissProgressDialog()V
    ...
    iget-object p0, p0, Lcom/heytap/msp/sdk/common/dialog/DialogHelper;->downloadDialog:Landroid/app/Dialog;
...
.method private downloadApp(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v2, p1}, Lcom/heytap/msp/sdk/common/utils/DownloadManager;->isUrlInCallQueue(Ljava/lang/String;)Z
    ...
    invoke-direct {p0, v1, p1}, Lcom/heytap/msp/sdk/common/dialog/DialogHelper;->finish(ILjava/lang/String;)V

    return-void

    :cond_0
    new-instance v2, Lcom/heytap/msp/sdk/common/dialog/DialogHelper$8;

    invoke-direct {v2, p0, p2, p1}, Lcom/heytap/msp/sdk/common/dialog/DialogHelper$8;-><init>(Lcom/heytap/msp/sdk/common/dialog/DialogHelper;Ljava/lang/String;Ljava/lang/String;)V

    invoke-static {}, Lcom/heytap/msp/sdk/base/common/executor/impl/a;->a()Lcom/heytap/msp/sdk/base/common/executor/IExecutor;

    move-result-object p1

    invoke-interface {p1, v2}, Lcom/heytap/msp/sdk/base/common/executor/IExecutor;->execute(Ljava/lang/Runnable;)V
...
.method private finish(ILjava/lang/String;)V
    ...
    invoke-static {p0, p1, p2}, Lcom/heytap/msp/sdk/common/statics/StatHelper;->onDownload(Landroid/content/Context;ILjava/lang/String;)V
...
.method private getActivity()Landroid/app/Activity;
    ...
    iget-object p0, p0, Lcom/heytap/msp/sdk/common/dialog/DialogHelper;->mRefActivity:Ljava/lang/ref/WeakReference;
...
.method private getMspApkDownPath()Ljava/lang/String;
    ...
    iget-object p0, p0, Lcom/heytap/msp/sdk/common/dialog/DialogHelper;->mPathsMap:Ljava/util/concurrent/ConcurrentHashMap;
...
.method private installExistApk(Ljava/lang/String;)V
    ...
    invoke-virtual {v2}, Lcom/heytap/msp/sdk/base/b;->g()I
    ...
    iget-object v6, p0, Lcom/heytap/msp/sdk/common/dialog/DialogHelper;->mContext:Landroid/content/Context;
    ...
    const-string v6, ".MspFileProvider"
    ...
    invoke-static {v2, v5, v1}, Landroidx/core/content/FileProvider;->getUriForFile(Landroid/content/Context;Ljava/lang/String;Ljava/io/File;)Landroid/net/Uri;
    ...
    :cond_1
    invoke-static {v4}, Lcom/heytap/msp/sdk/base/b;->a(B)V
    ...
    const-string v4, "App install fail"

    invoke-static {v1, v4, v2}, Lcom/heytap/msp/bean/Response;->create(ILjava/lang/String;Ljava/lang/Class;)Lcom/heytap/msp/bean/Response;

    move-result-object v1

    invoke-virtual {p1, v0, v1}, Lcom/heytap/msp/sdk/base/b;->a(Lcom/heytap/msp/bean/Request;Lcom/heytap/msp/bean/Response;)V

    const-string p1, "\u5b89\u88c5\u5931\u8d25 ==provider\u5f02\u5e38"

    invoke-direct {p0, v3, p1}, Lcom/heytap/msp/sdk/common/dialog/DialogHelper;->finish(ILjava/lang/String;)V
    ...
    invoke-virtual {v8, v6, v2}, Ljava/io/File;->setReadable(ZZ)Z

    invoke-virtual {v7}, Ljava/io/File;->getParentFile()Ljava/io/File;

    move-result-object v8

    invoke-virtual {v8, v6, v2}, Ljava/io/File;->setExecutable(ZZ)Z
...
.method private scanProviderPaths(Ljava/lang/String;)V
    ...
    invoke-static {v4, v3}, Landroidx/core/content/a;->a(Landroid/content/Context;Ljava/lang/String;)[Ljava/io/File;
    ...
    invoke-static {v4}, Landroidx/core/content/a;->a(Landroid/content/Context;)[Ljava/io/File;
    ...
    const-string v0, "scanProviderPaths: "
...
.method private showTipsDialog()V
    ...
    const-string v1, "no foreground2"
...
.method private showVerifyFailDialog()V
    ...
    const-string v1, "\u9a8c\u8bc1apk\u5f39\u7a97\u68c0\u67e5activity\u5931\u8d25"
...
.method public showDownloadDialog(Lcom/heytap/msp/bean/Request;)V
    ...
    const-string v4, "App downloading"

    invoke-static {v1, v4, v3}, Lcom/heytap/msp/bean/Response;->create(ILjava/lang/String;Ljava/lang/Class;)Lcom/heytap/msp/bean/Response;

    move-result-object v1

    invoke-virtual {v0, p1, v1}, Lcom/heytap/msp/sdk/base/b;->a(Lcom/heytap/msp/bean/Request;Lcom/heytap/msp/bean/Response;)V

    const-string p1, "\u5b89\u88c5\u6d41\u7a0b\u8fdb\u884c\u4e2d"

    :goto_0
    invoke-direct {p0, v2, p1}, Lcom/heytap/msp/sdk/common/dialog/DialogHelper;->finish(ILjava/lang/String;)V
    ...
    const-string v4, "has no foreground activity"
    ...
    const-string p1, "no foreground1"
    ...
    const-string p0, "Activity Context is NULL"
