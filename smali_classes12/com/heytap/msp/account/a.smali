...
.field private static b:Lcom/heytap/msp/account/receiver/a;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/heytap/msp/account/a;->c:Ljava/util/concurrent/atomic/AtomicBoolean;

    sput-boolean v1, Lcom/heytap/msp/account/a;->d:Z

    sput-boolean v1, Lcom/heytap/msp/account/a;->a:Z
...
.method public static a()Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    sget-object v0, Lcom/heytap/msp/account/a;->c:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method public static a(Landroid/content/Context;Lcom/heytap/msp/sdk/account/AccountConfig;)V
    .locals 5

    const-string v0, "AccountOperation"

    iget-boolean v1, p1, Lcom/heytap/msp/sdk/account/AccountConfig;->useHeytapAccount:Z
    ...
    sget-object v2, Lcom/heytap/usercenter/accountsdk/AccountSDKConfig$ENV;->ENV_RELEASE:Lcom/heytap/usercenter/accountsdk/AccountSDKConfig$ENV;

    goto :goto_0

    :cond_0
    sget-object v2, Lcom/heytap/usercenter/accountsdk/AccountSDKConfig$ENV;->ENV_PRE:Lcom/heytap/usercenter/accountsdk/AccountSDKConfig$ENV;

    goto :goto_0

    :cond_1
    sget-object v2, Lcom/heytap/usercenter/accountsdk/AccountSDKConfig$ENV;->ENV_DEV:Lcom/heytap/usercenter/accountsdk/AccountSDKConfig$ENV;

    goto :goto_0

    :cond_2
    sget-object v2, Lcom/heytap/usercenter/accountsdk/AccountSDKConfig$ENV;->ENV_TEST_3:Lcom/heytap/usercenter/accountsdk/AccountSDKConfig$ENV;

    goto :goto_0

    :cond_3
    sget-object v2, Lcom/heytap/usercenter/accountsdk/AccountSDKConfig$ENV;->ENV_TEST_1:Lcom/heytap/usercenter/accountsdk/AccountSDKConfig$ENV;

    :goto_0
    invoke-virtual {v1, v2}, Lcom/heytap/usercenter/accountsdk/AccountSDKConfig$Builder;->env(Lcom/heytap/usercenter/accountsdk/AccountSDKConfig$ENV;)Lcom/heytap/usercenter/accountsdk/AccountSDKConfig$Builder;
    ...
    invoke-virtual {v1}, Lcom/heytap/usercenter/accountsdk/AccountSDKConfig$Builder;->create()Lcom/heytap/usercenter/accountsdk/AccountSDKConfig;

    move-result-object v1

    invoke-virtual {v2, v1}, Lcom/heytap/usercenter/accountsdk/AccountAgentClient;->init(Lcom/heytap/usercenter/accountsdk/AccountSDKConfig;)V
    ...
    const-string v2, "useHeytapAccount: "

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v1

    iget-boolean v2, p1, Lcom/heytap/msp/sdk/account/AccountConfig;->useHeytapAccount:Z
    ...
    iget-boolean p1, p1, Lcom/heytap/msp/sdk/account/AccountConfig;->useHeytapAccount:Z
    ...
    const-string p1, "try to find OPAccountAgentWrapper"
    ...
    :try_start_1
    const-string p1, "com.heytap.opnearmesdk.OPAccountAgentWrapper"
    ...
    check-cast p1, Lcom/heytap/usercenter/accountsdk/AccountAgentInterface;

    invoke-static {p0, p1}, Lcom/heytap/usercenter/accountsdk/AccountAgent;->register(Landroid/content/Context;Lcom/heytap/usercenter/accountsdk/AccountAgentInterface;)V
    :try_end_1
    ...
    sput-object p0, Lcom/heytap/msp/account/a;->b:Lcom/heytap/msp/account/receiver/a;

    invoke-static {}, Lcom/heytap/msp/sdk/base/b;->d()Lcom/heytap/msp/sdk/base/b;

    move-result-object p0

    invoke-virtual {p0}, Lcom/heytap/msp/sdk/base/b;->k()Landroid/content/Context;

    move-result-object p0

    sget-object p1, Lcom/heytap/msp/account/a;->b:Lcom/heytap/msp/account/receiver/a;

    invoke-static {p0, p1}, Lcom/heytap/msp/account/receiver/b;->a(Landroid/content/Context;Lcom/heytap/msp/account/receiver/a;)V

    sget-object p0, Lcom/heytap/msp/account/a;->c:Ljava/util/concurrent/atomic/AtomicBoolean;
...
.method private static b(Landroid/content/Context;)V
    ...
    invoke-static {p0}, Lcom/heytap/msp/account/c;->a(Landroid/content/Context;)Z

    move-result v0

    if-nez v0, :cond_0

    sget-boolean v0, Lcom/heytap/msp/account/a;->d:Z

    if-nez v0, :cond_0

    :try_start_0
    invoke-static {p0}, Lcom/heytap/msp/account/c;->b(Landroid/content/Context;)V
    :try_end_0
...
.method public static f(Landroid/content/Context;Lcom/heytap/msp/bean/Request;)V
    ...
    sget-object v0, Lcom/heytap/msp/account/a;->b:Lcom/heytap/msp/account/receiver/a;
